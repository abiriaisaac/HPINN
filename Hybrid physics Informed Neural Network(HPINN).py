...
# data = pd.read_csv('Fu90°.csv')  # AM Ti-6Al-4V et al (Zhang [96])
# data = pd.read_csv('Li0°.csv')  # Ti-6Al-4V et al (Zhang [96])
# data = pd.read_csv('Li90°.csv')  # Ti-6Al-4V et al (Zhang [96])
# data = pd.read_csv('Fu90°_TGAN.csv')  # AM Ti-6Al-4V, generated by GAN
# data = pd.read_csv('Li0°_TGAN.csv')  # AM Ti-6Al-4V, generated by GAN
# data = pd.read_csv('Li90°_TGAN.csv')  # AM Ti-6Al-4V, generated by GAN
